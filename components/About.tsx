    ...
    <div className="about flex justify-between" id="about">
      <div className="left" data-aos="fade-right">
        ...
        <div className="left-text text-left px-16">
          ...
          <p className="text-xl">I started coding back in 2017 because someone looked at me and thought 'Hey you seem like you'd love this code stuff' and it turns out I did.</p>
          <p className="text-xl">
            I work with
